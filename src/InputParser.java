...
public final class InputParser {
    ...
    private static final String FIRST_NAME_PATTERN = "(?:[A-ZД„Д†ДЕЃЕѓГ“ЕљЕ№Е»][a-zД…Д‡Д™Е‚Е„ГіЕ›ЕєЕј]+)";
    private static final String LAST_NAME_PATTERN = "(?:[A-ZД„Д†ДЕЃЕѓГ“ЕљЕ№Е»][a-zД…Д‡Д™Е‚Е„ГіЕ›ЕєЕј]+)";
    ...
    private static final String LINE = "(?<"+ FN + ">" + FIRST_NAME_PATTERN + ")" + WHITESPACE + "(?<" + LN +">" + LAST_NAME_PATTERN + ")" +
            WHITESPACE + "(?<" + BD + ">" + BIRTHDAY_PATTERN + ")";
